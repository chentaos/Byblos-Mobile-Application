...
//    }
    ...
    public void login(String userName, String pw, ListenerCallBack callBack) throws IllegalArgumentException {
        ...
        DatabaseReference myRef = FirebaseDatabase.getInstance().getReference("User/Customer");
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Log.d("Login", "still running? : yes" + pw + "Customer");
            }
    ...
    public String welcomeMSG(){
        return String.format("Welcome %s! You are logged in as Customer.",userName);
    }
